...
\hypersetup{
  pdftitle={Diario Temtiano edición 27.05.2021},
  pdflang={es-es},
  hidelinks,
...
\addcontentsline{toc}{section}{Cambios previstos en la próxima edición}
...
\addcontentsline{toc}{section}{Cambios en duda y a evaluar para la próxima edición}
